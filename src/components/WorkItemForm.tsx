...
export function WorkItemForm() {
  ...
  useEffect(() => {
    ...
    const parentItem = allItems.find((i) => i.rowId === createChildParentId);
    const parentDisplayId = parentItem?.id ?? String(createChildParentId);
    const parentDisplay = parentItem
      ? `#${parentDisplayId} - ${parentItem.title}`
      : `#${parentDisplayId}`;
